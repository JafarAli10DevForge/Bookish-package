export * from '../models/AcceptFollowerPayloadDto';
...
export * from '../models/FriendRequestItem';
export * from '../models/FriendRequestItemEntityDto';
...
let typeMap: {[index: string]: any} = {
    ...
    "FriendRequestItemEntityDto": FriendRequestItemEntityDto,
