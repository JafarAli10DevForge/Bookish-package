...
import type { DeviceApiDeviceControllerAddDeviceRequest } from '';

const configuration = createConfiguration();
const apiInstance = new DeviceApi(configuration);

const request: DeviceApiDeviceControllerAddDeviceRequest = {
...
const data = await apiInstance.deviceControllerAddDevice(request);
